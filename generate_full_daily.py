...
def generate_news_section():
    ...
    # ---- AI生成六大板块 ----
    prompt = f"""你是刘海蟾点金的日报编辑，专注AI/算力/出海搞钱赛道，同时具备商业分析能力和落地表达力。

## 读者画像
- 身份：关注AI和进出口赛道的搞钱人
- 核心关注：AI/大模型/算力芯片、进出口/跨境电商/出海、搞钱机会和避坑
- 投资思维：供需错配、逆势机会、5层传导思维、天之道损有余补不足
- 不关心：娱乐圈八卦、体育赛事、纯消费生活类
- 语言风格：专业但不说黑话，分析有框架但必须落到具体行动
...
每条新闻格式：
- **标题**（提炼核心，不要照搬原标题，让人一看就知道有什么搞钱机会或风险）
  > 一句话点评：这条新闻对你搞钱有什么影响？新机会？供应链变化？还是得避坑？

## 二、搞钱雷达
扫出2-3个AI/出海赛道能抓住的机会，每个含：
- **机会名称**
- 具体是什么：供需缺口在哪，谁在赚钱
- 怎么入手：给一个今天就能开始的第一步
...
选1-2条最重要的新闻，做5层传导分析：
- 第1层：事件本身（一句话）
- 第2层：直接影响（对AI/出海供应链的即时冲击）
- 第3层：市场反应（资本/企业/竞争格局如何变化）
- 第4层：中期演变(3-6个月)
- 第5层：长期格局(1-2年)
- 🔮 天之道：损什么(有余)？补什么(不足)？——用"天之道损有余补不足"的哲学框架，指出这条新闻中什么正在过剩被削减，什么正在短缺被填补

## 五、避坑提醒
找出1-2个AI/出海赛道表面光鲜但暗藏风险的信号，每个含：
- 现象：什么赛道/项目看起来很火
- 真相：为什么可能是坑（产能过剩/政策收紧/竞争红海）
- 怎么办：怎么保护自己
