...
IMPACT_CHAIN_TEMPLATES = [
    ...
    {'triggers': ['稀土', '镝', '铽', '钕', '铕', '战略金属', '出口管制',
     ...
     'layers': [
         ...
         ('替代材料/回收料需求爆发→普通人可做: ①收购废电机拆钕铁硼磁铁卖给磁材厂 ②陶瓷刀具替代硬质合金卖给机加工厂 ③国内有钨库存的贸易商对接日韩缺钨买家赚价差', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['ai', '算力', 'gpu', '大模型', '英伟达', 'nvidia', '人工智能', '机器学习', '深度学习', 'openai', 'gpt', 'deepseek', 'claude', 'gemini', 'llm', 'hbm', '智谱', '文心', '通义', 'kimi', '豆包', 'minimax'],
     'layers': [
         ...
         ('普通人可做: ①对接有闲置A100的实验室和缺卡的AI公司收10%撮合费 ②收购倒闭AI公司的二手H100转卖给新入局者 ③教中小企业用DeepSeek替代GPT降本收培训费 ④华为昇腾选型对接帮企业省采购成本', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['芯片', '半导体', '台积电', '晶圆', '代工', '封装', '封测'],
     'layers': [
         ...
         ('普通人可做: ①收购IC设计公司积压库存芯片转卖给缺货终端厂 ②国产MCU/电源芯片方案代理卖给替代进口的客户 ③收购倒闭厂二手贴片机转卖 ④帮终端厂做芯片国产替代选型评估收咨询费', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['机器人', '具身智能', '智能体', '人形机器人'],
     'layers': [
         ...
         ('普通人可做: ①给工厂机械臂做定期保养换油脂收年费 ②帮餐饮店部署送餐机器人按月收运维费 ③教工厂技工编程调试协作机器人收培训费 ④收购展会演示用机器人翻新转卖给中小企业', '6-12月', '短缺'),
     ],
    ...
    {'triggers': ['出口', '关税', '制裁', '贸易', '禁运', '脱钩', '实体清单', '反倾销', '反补贴', '中美', '外贸'],
     'layers': [
         ...
         ('普通人可做: ①帮中国卖家经越南换标签转口到美国赚运费差 ②收购制裁后卖不动的库存折价转卖到非制裁地区 ③帮企业做EAR实体清单自查申报 ④帮买方找非中国替代供应商收撮合费', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['出海', '全球化', '海外', '跨境', '品牌出海', '国际化', '东南亚', '欧洲', '美洲', '中东', '非洲'],
     'layers': [
         ...
         ('普通人可做: ①把国内品牌对接给东南亚Shopee经销商收佣金 ②帮国内品牌做TikTok Shop东南亚代运营按GMV抽成 ③在越南租仓做集运发货给跨境卖家 ④帮企业做目标国FDA/CE认证申请', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['新能源', '锂', '光伏', '储能', '电网', '充电', '电池'],
     'layers': [
         ...
         ('普通人可做: ①收购光伏厂停产积压组件转卖到非洲/中东 ②给小区/商场装充电桩赚安装费+运维年费 ③收购退役动力电池拆解提锂钴卖给材料厂 ④代理家用储能产品卖给别墅/农村市场', '6-12月', '短缺'),
     ],
    ...
    {'triggers': ['降息', '央行', '利率', '美联储', '加息', '流动性'],
     'layers': [
         ...
         ('普通人可做: ①两岸利差5%时帮台商做人民币/台币定存套利 ②对接有余钱个人和缺周转中小企业收2%撮合费 ③找到城商行5%大额存单对接给有钱人 ④帮出口企业做远期结汇锁汇收手续费', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['腾讯', '阿里', '字节', '百度', '快手', '网易', '华为', '美团', '京东', '拼多多', '小米', 'oppo', 'vivo', '滴滴', '蚂蚁', '京东', '拼多多'],
     'layers': [
         ...
         ('普通人可做: ①大厂砍掉的本地生活/SaaS赛道直接接手存量客户 ②把大厂裁掉的AI工程师介绍给创业公司收猎头费 ③帮期权员工找折价买家对接变现收3% ④接手大厂砍掉的外包项目转包给小团队赚差价', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['ipo', '上市', '过会', 'a股', '港股', '招股', '融资', '天使轮', 'a轮', 'b轮', 'c轮', '并购', '收购', '入股', '投资'],
     'layers': [
         ...
         ('普通人可做: ①上市前帮老股东找接盘方转让老股收2-3%佣金 ②帮解禁股东做减持节奏规划对接买方收咨询费 ③帮Pre-IPO公司做投资者关系管理按月收费 ④帮投资方找标的收FA佣金', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['庙宇', '供奉', '开光', '法会', '线上信仰', '财神', '赵公明', '信仰'],
     'layers': [
         ...
         ('普通人可做: ①帮寺庙做公众号+小程序供灯祈福收代运营月费 ②从义乌批发法器/香烛/佛珠供给线上信仰平台 ③帮寺庙搭直播间做法会直播收技术服务费 ④帮庙宇IP授权给文创公司收授权费', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['彩票', '彩券', '台彩', '威力彩', '大乐透', '公益彩券'],
     'layers': [
         ...
         ('普通人可做: ①组织50人合买群收5%管理费+中奖提成 ②做选号数据分析小程序卖给玩家收会员费 ③两岸赔率差3%时跨境代买套利 ④帮退出经销商找接盘人收牌照转让佣金', '1-3月', '短缺'),
     ],
    ...
    {'triggers': ['台湾', '两岸', '小三通', '金门', '台海', '台积电', '台企', '陆资', '台商', '新竹', '台北'],
     'layers': [
         ...
         ('普通人可做: ①帮台湾买家代购大陆淘宝集运到台湾赚运费差 ②两岸汇差2%+时帮台商民间兑汇收1% ③在金门租仓做小三通货物中转收仓储费 ④帮台商做ODI合规申请把资金合规汇回大陆', '1-3月', '短缺'),
     ],
    ...
    {'triggers': ['涨价', '缺货', '断供', '减产', '铜', '铝', '钢', '硫酸', '锂', '石油', '天然气', '铁矿石', '煤炭', '粮食', '大豆', '猪肉'],
     'layers': [
         ...
         ('普通人可做: ①收购废铜线/废铝型材卖给冶炼厂赚回收差价 ②卖铝线缆替代铜线缆给成本敏感的电缆厂 ③收购经销商折价清仓钢材转卖到县城工地 ④国内铜价低于LME时帮出口商对接海外买家赚价差', '2-4月', '短缺'),
     ],
    ...
    {'triggers': ['融资', '天使轮', 'a轮', 'b轮', 'c轮', '并购', '收购', '入股', '投资', '估值', '独角兽'],
     'layers': [
         ...
         ('普通人可做: ①帮投资方找标的/帮创业者找钱收2-3%FA佣金 ②并购后帮被裁团队对接新雇主收猎头费 ③帮有钱基金对接缺钱优质项目收撮合费 ④帮投资方做投后财务合规体检按项目收费', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['政策', '新规', '监管', '合规', '牌照', '准入', '反垄断', '数据安全', '隐私'],
     'layers': [
         ...
         ('普通人可做: ①帮企业做数据安全合规自查+代办申报收咨询费 ②帮退出持牌方找新入局者接牌收转让佣金 ③代理国产加密/隐私计算卖给需合规企业 ④帮受监管影响工厂对接资产处置方清盘', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['大豆', '玉米', '小麦', '棉花', '白糖', '糖价', '稻谷', '油菜籽', '棕榈油',
     ...
     'layers': [
         ...
         ('普通人可做: ①国内糖价低于国际时帮出口商对接海外买家赚价差 ②代理新型化肥/种子卖给种植大户赚经销差价 ③在产区租冷库帮贸易商存水果蔬菜赚仓储费 ④卖植物蛋白肉替代涨价大豆蛋白给食品厂', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['黄金', '白银', '铂金', '钯金', '贵金属', '金矿', '银矿',
     ...
     'layers': [
         ...
         ('普通人可做: ①收购旧手机/电路板提炼金银卖给精炼厂 ②帮消费者做旧金首饰折价换新收加工费 ③对接有废料的电子厂和回收商收3%撮合费 ④帮高净值客户找低溢价金条渠道省2-3%', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['突破', '首创', '世界首例', '里程碑', '颠覆', '革命性', '量产突破', '商用化',
     ...
     'layers': [
         ...
         ('普通人可做: ①教企业用ChatGPT/DeepSeek做文案客服降本收培训费 ②代理固态电池/氢能配套材料卖给研发机构 ③收购被淘汰旧产线设备转卖到欠发达地区 ④帮企业做专利布局分析收咨询费 ⑤帮新品做众筹预售代理收佣金', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['硫酸', '硫磺', '磷酸', '磷肥', '尿素', '钾肥', '氮肥', '复合肥',
     ...
     'layers': [
         ...
         ('普通人可做: ①收购化工厂副产废酸废碱卖给需酸碱的中和厂 ②代理生物基可降解材料替代石化产品卖给包装厂 ③收购停产厂化工品库存折价转卖下游 ④国内化工品低于国际时帮出口商对接海外买家', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['海峡', '港口', '航线', '封锁', '通航', '禁运', '海上通道',
     ...
     'layers': [
         ...
         ('普通人可做: ①帮走不了海运的货主对接中欧班列/空运赚运费差 ②在港口附近租仓帮延迟货物暂存赚仓储费 ③帮货主买航运战争险收手续费 ④断供期间帮有库存卖方对接急缺买方赚价差', '1-3月', '短缺'),
     ],
    ...
    {'triggers': [],
     'layers': [
         ...
         ('普通人可做: ①收购折价库存转卖下沉市场赚差价 ②找替代品供给方对接缺货买方收佣金 ③收购废旧物资卖给回收厂赚差价 ④国内低价时对接海外高价买家赚出口价差 ⑤帮有信息的人对接需要信息的人收撮合费', '3-6月', '短缺'),
     ],
