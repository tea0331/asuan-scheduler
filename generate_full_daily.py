...
IMPACT_CHAIN_TEMPLATES = [
    ...
    {'triggers': ['融资', '天使轮', 'a轮', 'b轮', 'c轮', '并购', '收购', '入股', '投资', '估值', '独角兽'],
     'layers': [
         ('标的公司股权', '短缺', '立即', '融资/并购消息→标的稀缺性上升→股权争夺'),
         ('同类竞品估值', '短缺', '1-2月', '标杆融资→竞品估值上涨→融资难度增加'),
         ('投资方资金', '过剩', '1-3月', '大笔资金到位→短期内找不到合适标的'),
         ('上下游整合机会', '短缺', '3-6月', '并购后产业链整合→整合服务需求爆发'),
         ('退出通道', '短缺', '6-12月', 'IPO/并购退出→中介机构产能不足'),
     ],
     'fracture': 'L3-L4（资金过剩→整合机会）', 'window': '3-6个月'},

    # 16. 政策/监管
    {'triggers': ['政策', '新规', '监管', '合规', '牌照', '准入', '反垄断', '数据安全', '隐私'],
     'layers': [
         ('合规服务', '短缺', '立即', '新规出台→企业急需合规顾问'),
         ('牌照/资质', '短缺', '1-3月', '准入门槛提高→牌照稀缺性上升'),
         ('受影响行业产能', '过剩', '1-3月', '监管收紧→部分产能被迫闲置'),
         ('替代方案/技术', '短缺', '3-6月', '合规要求→替代技术需求爆发'),
         ('游说/政策咨询', '短缺', '3-6月', '企业需要影响政策→游说服务缺口'),
     ],
     'fracture': 'L2-L4（牌照→替代技术）', 'window': '3-6个月'},
