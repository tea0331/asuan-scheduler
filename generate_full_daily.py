...
- **标题**
  ...
  > 8. 新发明/新应用/新skill/新产品(全球关注): 时代级突破(固态电池/核聚变/量子计算/脑机接口/室温超导/基因编辑) + 实用级新应用(AI Agent/AI制药/无人驾驶出租车/商业航天) + 全球关注新产品(ChatGPT/GPT-5/Cybertruck/Vision Pro/星链)。能创造新产业或摧毁旧产业供需结构
  > 9. 行业数据: 同比/环比/进出口量/库存/产能利用率，量化证据最强的触发源

  > ❌ 禁止推送（无因果推演价值）:
  > - 融资PR（XX完成X轮融资）、股票盘前涨跌、普通产品发布PR（手机更新/SaaS上线）、会议预告、人事变动
  > - 注意: 普通产品发布(手机更新/SaaS上线/小版本迭代)≠新发明/新应用。只有全球关注的、能改变产业供需结构的才算
