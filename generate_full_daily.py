...
USER_PROFILE_V7 = {
    ...
    # V20-fix4: 农产品产量预警 — 减产/歉收/丰收/种植面积变化直接改变供给
    '减产': 5, '增产': 4, '歉收': 5, '丰收': 3, '种植面积': 5,
    '产量预估': 5, '产量预测': 5, '产量下降': 5, '产量增长': 4,
    '收成': 4, '收割': 3, '播种': 3, '产区': 4, '主产区': 5,
    '大豆': 4, '玉米': 4, '小麦': 4, '棉花': 4, '白糖': 4, '糖价': 5,
    '稻谷': 4, '油菜籽': 4, '棕榈油': 4, '橡胶': 4, '咖啡': 3, '可可': 3,
    '粮食': 4, '化肥': 4, '农药': 3, '饲料': 3,
    # V20-fix4: 贵金属产量预警
    '黄金': 4, '白银': 4, '铂金': 4, '钯金': 4, '贵金属': 5,
    '金矿': 4, '银矿': 4, '开采量': 5, '矿产产量': 5, '冶炼产量': 5,
    # V20-fix8: 小金属/战略金属 — 钨钼锑镓锗等国外缺货高价值信号
    '钨': 5, '钨价': 5, '厦门钨业': 4, '钼': 5, '钼价': 5,
    '锑': 5, '锑价': 5, '镓': 5, '锗': 5, '铟': 4, '锗价': 5,
    '钴': 4, '钴价': 4, '镍': 3, '镍价': 4, '锡': 4, '锡价': 4,
    '铬': 4, '钒': 4, '钛': 3, '战略金属': 5, '小金属': 5, '稀有金属': 5,
    '出口管制': 5, '限制出口': 5, '禁止出口': 5,
    ...
    # V20-fix5: AI/算力/信息化保留
    '算力': 4, 'GPU': 4, '英伟达': 3, 'NVIDIA': 3, '数据中心': 3,
    '大模型': 4, '人工智能': 4, '智能体': 3, '芯片': 3, '半导体': 3,
    '台积电': 3, '晶圆': 2, '光刻': 2, 'HBM': 3,
    # V20-fix6: 时代级+实用级新发明/新应用/新skill/新产品(全球关注) — 改变产业供需结构
    # 时代级: 能创造或摧毁整个产业的根本突破
    '突破': 5, '首创': 5, '世界首例': 5, '里程碑': 5, '颠覆': 5,
    '革命性': 5, '产业化': 5, '量产突破': 5, '商用化': 5,
    '固态电池': 5, '核聚变': 5, '室温超导': 5, '量子计算': 5,
    '量子比特': 5, '脑机接口': 5, '基因编辑': 5, '人造肉': 4,
    '可控核聚变': 5, '小型反应堆': 5, '碳捕获': 4, '绿氢': 4,
    '人形机器人': 5, '具身智能': 4, 'AGI': 5, '通用人工智能': 5,
    # 实用级: 已落地的新应用/新skill/全球关注新产品
    '首发': 4, '全球首发': 5, '全球首秀': 5, '正式商用': 5,
    '大规模商用': 5, '规模化部署': 5, '批量交付': 4, '量产车型': 4,
    '新架构': 4, '新一代': 3, '全新一代': 4, '跨代': 4,
    'ChatGPT': 5, 'GPT-5': 5, 'GPT-6': 5, 'Sora': 4, 'Gemini': 4,
    'Cybertruck': 4, 'Vision Pro': 4, '折叠屏': 3,
    '太空旅行': 5, '商业航天': 5, '可回收火箭': 5, '星链': 4,
    '无人驾驶出租车': 5, '飞行汽车': 5, 'eVTOL': 5,
    'AI Agent': 4, 'AI编程': 4, 'AI制药': 5, 'AI设计': 4,
...
IMPACT_CHAIN_TEMPLATES = [
    ...
    {'triggers': ['稀土', '镝', '铽', '钕', '铕', '战略金属', '出口管制',
     ...
     'layers': [
         ...
         ('替代材料/回收料/废旧物资需求爆发→普通人可做: 废料回收/替代品经销/国内外价差中间人', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['ai', '算力', 'gpu', '大模型', '英伟达', 'nvidia', '人工智能', '机器学习', '深度学习', 'openai', 'gpt', 'deepseek', 'claude', 'gemini', 'llm', 'hbm', '智谱', '文心', '通义', 'kimi', '豆包', 'minimax'],
     'layers': [
         ...
         ('普通人可做: ①算力撮合中间人(对接有卡方和需卡方) ②二手GPU/服务器回收转卖 ③AI应用落地培训/咨询 ④国产替代芯片的信息差代理', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['芯片', '半导体', '台积电', '晶圆', '代工', '封装', '封测'],
     'layers': [
         ...
         ('普通人可做: ①库存芯片清仓中间人(对接积压方和缺货方) ②国产替代芯片方案经销 ③二手电子设备回收翻新 ④芯片选型咨询服务', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['机器人', '具身智能', '智能体', '人形机器人'],
     'layers': [
         ...
         ('普通人可做: ①机器人售后维修/保养服务 ②场景落地集成(工厂/餐饮/物流) ③机器人操作培训 ④二手机器人翻新转卖', '6-12月', '短缺'),
     ],
    ...
    {'triggers': ['出口', '关税', '制裁', '贸易', '禁运', '脱钩', '实体清单', '反倾销', '反补贴', '中美', '外贸'],
     'layers': [
         ...
         ('普通人可做: ①转口贸易物流中间人(中国→越南/墨西哥→美国) ②受限库存折价清仓代理 ③合规咨询代办 ④替代供应商对接', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['出海', '全球化', '海外', '跨境', '品牌出海', '国际化', '东南亚', '欧洲', '美洲', '中东', '非洲'],
     'layers': [
         ...
         ('普通人可做: ①海外渠道对接中间人(国内品牌+海外经销商) ②跨境电商代运营 ③海外仓/集运服务 ④本地化翻译/合规咨询', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['新能源', '锂', '光伏', '储能', '电网', '充电', '电池'],
     'layers': [
         ...
         ('普通人可做: ①光伏组件库存清仓中间人 ②充电桩安装/运维 ③废旧电池回收 ④分布式光伏/储能代理经销', '6-12月', '短缺'),
     ],
    ...
    {'triggers': ['降息', '央行', '利率', '美联储', '加息', '流动性'],
     'layers': [
         ...
         ('普通人可做: ①两岸/跨境汇率差中间人 ②中小企业融资对接(有钱方和缺钱方) ③高息资产信息差撮合 ④汇率对冲咨询', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['腾讯', '阿里', '字节', '百度', '快手', '网易', '华为', '美团', '京东', '拼多多', '小米', 'oppo', 'vivo', '滴滴', '蚂蚁', '京东', '拼多多'],
     'layers': [
         ...
         ('普通人可做: ①接盘大厂退出的垂直赛道 ②裁员人才转介/猎头 ③员工期权折价兑现中间人 ④大厂砍掉的外包项目接手', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['ipo', '上市', '过会', 'a股', '港股', '招股', '融资', '天使轮', 'a轮', 'b轮', 'c轮', '并购', '收购', '入股', '投资'],
     'layers': [
         ...
         ('普通人可做: ①老股转让信息差撮合 ②IR/市值管理咨询服务 ③解禁前股东对接买方 ④FA(财务顾问)撮合佣金', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['庙宇', '供奉', '开光', '法会', '线上信仰', '财神', '赵公明', '信仰'],
     'layers': [
         ...
         ('普通人可做: ①庙宇数字化代运营/SaaS ②信仰商品供应链(法器/供养品) ③线上法会直播技术服务 ④庙宇IP授权代理', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['彩票', '彩券', '台彩', '威力彩', '大乐透', '公益彩券'],
     'layers': [
         ...
         ('普通人可做: ①可信赖的合买组织者(收撮合费) ②彩票数据分析服务 ③跨区赔率差套利 ④经销牌照转让中介', '1-3月', '短缺'),
     ],
    ...
    {'triggers': ['台湾', '两岸', '小三通', '金门', '台海', '台积电', '台企', '陆资', '台商', '新竹', '台北'],
     'layers': [
         ...
         ('普通人可做: ①两岸代购/集运服务 ②台币/人民币兑换中间人 ③金门中转仓储 ④台商资金回流合规咨询', '1-3月', '短缺'),
     ],
    ...
    {'triggers': ['涨价', '缺货', '断供', '减产', '铜', '铝', '钢', '硫酸', '锂', '石油', '天然气', '铁矿石', '煤炭', '粮食', '大豆', '猪肉'],
     'layers': [
         ...
         ('普通人可做: ①废料回收(废铜/废铝/废钢) ②替代品经销(铝代铜/塑代钢) ③经销商库存清仓代理 ④国内外价差中间人', '2-4月', '短缺'),
     ],
    ...
    {'triggers': ['融资', '天使轮', 'a轮', 'b轮', 'c轮', '并购', '收购', '入股', '投资', '估值', '独角兽'],
     'layers': [
         ...
         ('普通人可做: ①FA(财务顾问)撮合佣金 ②并购后人才/资产安置 ③投资方与标的对接中间人 ④投后管理咨询', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['政策', '新规', '监管', '合规', '牌照', '准入', '反垄断', '数据安全', '隐私'],
     'layers': [
         ...
         ('普通人可做: ①合规代办/咨询服务 ②牌照转让中介 ③替代技术方案经销 ④受影响企业资产/人员安置对接', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['大豆', '玉米', '小麦', '棉花', '白糖', '糖价', '稻谷', '油菜籽', '棕榈油',
     ...
     'layers': [
         ...
         ('普通人可做: ①替代农产品进出口(国内外价差) ②农资(化肥/种子)经销 ③农产品冷链/仓储 ④食品替代方案(植物蛋白代动物蛋白)', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['黄金', '白银', '铂金', '钯金', '贵金属', '金矿', '银矿',
     ...
     'layers': [
         ...
         ('普通人可做: ①废旧贵金属回收(旧手机/电路板提金) ②旧金兑换服务 ③回收渠道中间人 ④贵金属投资信息差咨询', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['突破', '首创', '世界首例', '里程碑', '颠覆', '革命性', '量产突破', '商用化',
     ...
     'layers': [
         ...
         ('普通人可做: ①新技术应用培训/咨询 ②配套材料/零部件经销 ③旧技术设备回收翻新 ④专利/标准信息服务 ⑤早期产品预售代理', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['硫酸', '硫磺', '磷酸', '磷肥', '尿素', '钾肥', '氮肥', '复合肥',
     ...
     'layers': [
         ...
         ('普通人可做: ①副产物/废料回收经销 ②替代化工品(生物基/可降解)代理 ③经销商库存清仓 ④化工品国内外价差中间人', '3-6月', '短缺'),
     ],
    ...
    {'triggers': ['海峡', '港口', '航线', '封锁', '通航', '禁运', '海上通道',
     ...
     'layers': [
         ...
         ('普通人可做: ①替代运输通道代理(中欧班列/陆运/空运) ②本地化仓储服务 ③航运保险/合规咨询 ④到货延迟期间的库存调剂中间人', '1-3月', '短缺'),
     ],
    ...
    {'triggers': [],
     'layers': [
         ...
         ('普通人可做: ①库存清仓代理 ②替代品经销 ③废旧物资回收 ④国内外价差中间人 ⑤信息差撮合', '3-6月', '短缺'),
     ],
...
⚠️ 核心原则: 很多高门槛资源(稀土/钨/黄金/芯片)普通人买不到也卖不了，但你要从这类新闻推导因果链，找到链条末端普通人可以做的商机——替代品经销/废料回收/国内外价差中间人/二手设备/库存清仓/信息差撮合。
...
4. ❌ 融资PR/股票盘前涨跌/普通产品发布PR/会议预告/人事变动——禁止推送，无因果推演价值
5. 只推送9类高价值触发源: 重大签署/国内新规/AI算力信息化/供需断裂/产能变化/地缘通道/农产品贵金属产量预警/新发明新应用/行业数据
6. ⭐ 重大签署类新闻（国家间协议/贷款/合作）必须深度推演因果链
7. ⭐ 国内新政策/新规类新闻（国务院/部委/省级）必须深度推演因果链
8. ⭐ 农产品/贵金属产量预警（减产/歉收/种植面积/开采量变化）必须深度推演因果链
9. ⭐ 新发明/新应用/新skill/新产品(全球关注)必须深度推演因果链——时代级突破(固态电池/核聚变) + 实用级新应用(AI Agent/无人驾驶) + 全球关注新产品(ChatGPT/Cybertruck)
10. 注意: 普通产品发布(手机更新/SaaS上线/小版本迭代)≠新发明新应用，前者禁止后者必须推演
11. 金句每天不同，结合当日主题
12. 总字数2000-3000字
13. ⏰ 所有时间窗口基于{today_str}推算
14. 📍 优先挖掘台湾相关机会
{scene_context}
{chain_ctx}"""
