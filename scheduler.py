...
🔴 **天之道框架（必用）**：对每条推演，必须用"天之道，损有余而补不足"分析供需再平衡：
- **有余（供给过剩/估值过高/关注过度）**：什么正在被"损"——价格下跌、利润压缩、竞争加剧
- **不足（供给短缺/估值偏低/关注不足）**：什么正在被"补"——价格上涨、机会涌现、蓝海出现
- **再平衡方向**：市场将如何自发修正这个失衡？修正过程中谁是赢家/输家？
- **行动含义**：在再平衡完成前，现在该站在"有余"那边还是"不足"那边？
...
🔴 **天之道框架（必用）**：对每条推演，用"天之道，损有余而补不足"分析供需再平衡：
- **有余（供给过剩/估值过高/关注过度）**：什么正在被"损"
- **不足（供给短缺/估值偏低/关注不足）**：什么正在被"补"
- **再平衡方向**：市场如何自发修正？修正中谁是赢家/输家？
- **行动含义**：在再平衡完成前，站在哪边？
